module.exports = function(app) {
    ...
    app.post('/setyoutube',jsonParser, function(req, res) {
      console.log(req.form);
      console.log("Link!!",req.body.link);
//    console.log("could find body parsers", urlencodedParser);
    //  if (!req.body) return res.sendStatus(400);
    var device = req.body.device || 'def';
    var youtube_link = req.body.link || 'def'; //'https://www.youtube.com/watch?v=IH8RVvIHB9E';
